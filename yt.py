    ...
    def __init__(self):
        ...
        def mp3(self, video):
            try:
                ...
                messagebox.showinfo("Success", "Complete get mp3 file: {}".format(video.title))
            except:
        ...
        def mp4(self, video):
            try:
                ...
                messagebox.showinfo("Success", "Complete get mp4 file: {}".format(video.title))
            except:
                messagebox.showerror("Error", "File already exist")
        ...
        def all_mp3(self, videos):
            for video in videos:
                mp3(self, video)
        
        def all_mp4(self, videos):
            for video in videos:
                mp4(self, video)
        ...
        def playlist(self, yt):
            ...
            Button(self, text="all mp3", font='Helvetica 10 bold', command= lambda: all_mp3(self, videos)).pack(fill=X)
            Button(self, text="all mp4", font='Helvetica 10 bold', command= lambda: all_mp4(self, videos)).pack(fill=X)
            ...
            for i in range(len(videos)):
                title = Label(self, text=videos[i].title, font='Helvetica 10 bold')
                mp3_btn = Button(self, text="mp3", font='Helvetica 10 bold', command= lambda i=i: mp3(self, videos[i]))
                mp4_btn = Button(self, text="mp4", font='Helvetica 10 bold', command= lambda i=i: mp4(self, videos[i]))
